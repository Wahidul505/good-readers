...
const Blogs = () => {
    return (
        <div>
            ...
            <p>Tags, which clearly describes their purposes are Semantic Tags. A semantic tag clearly describes its meaning both the browser and the developer himself. Tags, such as  </p>
        </div>
    );
};
